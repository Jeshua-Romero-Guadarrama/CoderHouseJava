...
CREATE TABLE IF NOT EXISTS comprobantes_prestamo (
    ...
    total_libros INT NOT NULL,
    CONSTRAINT fk_comprobante_socio FOREIGN KEY (socio_id) REFERENCES socios(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS detalles_prestamo (
    ...
    CONSTRAINT fk_detalle_comprobante FOREIGN KEY (comprobante_id) REFERENCES comprobantes_prestamo(id) ON DELETE CASCADE,
    CONSTRAINT fk_detalle_libro FOREIGN KEY (libro_id) REFERENCES libros(id) ON DELETE CASCADE
);